...
ERROR_CATALOG: dict[str, PublicAccessErrorDetail] = {
    ...
    "invalid_message": PublicAccessErrorDetail("invalid_message", "The message could not be accepted.", False, 400),
    "idempotency_key_required": PublicAccessErrorDetail("idempotency_key_required", "An idempotency key is required.", False, 400),
    "invalid_idempotency_key": PublicAccessErrorDetail("invalid_idempotency_key", "The idempotency key is not valid.", False, 400),
    "idempotency_conflict": PublicAccessErrorDetail("idempotency_conflict", "The idempotency key was used for a different request.", False, 409),
    "request_in_progress": PublicAccessErrorDetail("request_in_progress", "The request is already in progress.", True, 409),
