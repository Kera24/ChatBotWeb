...
import { getWidgetDetail, getWidgetDraft, getWidgetEmbed, listWidgetOrigins, listWidgetSdkVersions } from "../../../lib/api/widgets";
...
async function loadWidgetAdminData(session: DevelopmentDashboardSession, widgetId: string) {
  try {
    const [widget, draft, origins, embed, sdkVersions] = await Promise.all([
